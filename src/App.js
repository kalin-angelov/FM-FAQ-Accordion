    ...
    <div className="App">
      ...
      <ul>
        ...
        <li>
          ...
          <p className="answer-to-question-one" style={{display: 'none'}}>
        ...
        <div className="question-container">
          ...
          <svg 
            ...
            <p className="answer-to-question-two" style={{display: 'none'}}>
        ...
        <p className="answer-to-question-three" style={{display: 'none'}}>
        ...
        <div className="question-container">
          ...
          <p className="answer-to-question-four" style={{display: 'none'}}>
